                ...
                case "csharp":
                    CodeEditor.SyntaxHighlighting = new SyntaxHighlightLanguage
                    {
                        ...
                        Highlights = new SyntaxHighlights[]
                        {
                            ...
                            new SyntaxHighlights(@"\b(int|char|float|double|decimal|string|bool|void|var|class|struct|enum|interface|namespace|using|public|private|sealed|partial|event|protected|object|readonly|get|set|internal|static|required|abstract|virtual|override|new|this|base|typeof|sizeof|true|false|null|async|is|as|or)\b", KeywordColor, KeywordColor),
                            new SyntaxHighlights(@"""(?:[^""\\]|\\.)*""", StringColor, StringColor),
                            new SyntaxHighlights(@"@""(?:[^""]|"""")*""", StringColor, StringColor),
